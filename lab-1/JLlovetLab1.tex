...
\begin{enumerate}
  ...
  \item Have reasonable error checking and report issues in a helpful way to the user
\end{enumerate}
...
\begin{verbatim}
  ...
  python3.14 -m lab1: error: the following arguments are required: in_file, out_file
\end{verbatim}
}
