...
Note: I used unit tests to help with the development of my code and to ensure that I did not break portions of the codebase as I developed. I referenced several resources to get back up to speed with testing in python. \parencite{PythonDocumentationUnittestUnit, CodewithJosh2024HowToTest, CoreySchafer2017PythonTutorial, ArjanCodes2025HowToWriteGreatUnitTestsInPython} Similarly, I checked multiple resources for information about logging \parencite{PythonDocumentationLoggingLogging, PythonDocumentationLoggingCookbook}, error handling \parencite{PythonDocumentationErrorsAndExceptions}, match syntax \parencite{PythonEnhancementProposalsPEP0636}, and typing \parencite{PythonDocumentationTypingLiterals}. In addition to these, I referenced the Google Python Style Guide \parencite{GooglePythonStyleGuide} for conventions about docstring formatting.
